...
=head3 IO::FD::accept_multiple
	...
	my @new_fds;
	my @peers;
	my $count=accept_multiple(@new_fds, @peers, $listen_sock, $force_nb)
...
from and must be in a non blocking listening state.  The C<$force_nb> flag
forces a nonblocking state on accepted sockets.
