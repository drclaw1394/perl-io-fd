...
It also implements non core functions such as C<dup>, C<mkstemp>, supplementing
the L<POSIX> module.
...
Currently this module is focused on Unix type systems, as this is the natural
...
Perl makes working with text files easy, thanks to the use of B<file handles>.
Line splitting, UTF-8, EOL processing etc. are awesome and make your life
easier.
...
You will need to Look at the code for documentation at the moment
